...
def load():
    return {
        ...
        'avr': {
            'SEXS': [
                ['name', 'gen', 'K', 'T_a', 'T_b', 'T_e', 'E_min', 'E_max'],
                ['AVR1', 'G1', 100, 1.0, 0.019, 0.5, -3, 3],
                ['AVR2', 'G2', 100, 1.0, 0.019, 0.5, -3, 3],
                ['AVR3', 'G3', 100, 1.0, 0.019, 0.5, -3, 3],
                ['AVR4', 'G4', 100, 1.0, 0.019, 0.5, -3, 3],
            ]
        },

        'avr0': {
            'AVR_WITH_FEEDBACK': [
                ['name', 'gen', 'K_a', 'K_e', 'T_e', 'K_f', 'T_f', 'E_min', 'E_max'],
                ['AVR1', 'G1',   100, 2.0, 10.0, 0.5, -3, 3],
                ['AVR2', 'G2',   100, 2.0, 10.0, 0.5, -3, 3],
                ['AVR3', 'G3',   100, 2.0, 10.0, 0.5, -3, 3],
                ['AVR4', 'G4',   100, 2.0, 10.0, 0.5, -3, 3],
        ...
        'bat_ctrl': {
            ...
            'WASH_LEAD_LAG': [
                ...
                ['BAT_CTRL_WASH_1', 'angle',  'G3', 'G1', 'BAT1',  100,  10,  0.8,  0.8,   0.13,   0.13,     0.9],
            ]
        }
    }